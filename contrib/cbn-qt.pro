...
RESOURCES += src/qt/cbn.qrc src/qt/cbn_locale.qrc

TRANSLATIONS += src/qt/locale/cbn_bg.ts \
                src/qt/locale/cbn_de.ts \
                src/qt/locale/cbn_en.ts \
                src/qt/locale/cbn_es.ts \
                src/qt/locale/cbn_fi.ts \
                src/qt/locale/cbn_fr.ts \
                src/qt/locale/cbn_it.ts \
                src/qt/locale/cbn_ja.ts \
                src/qt/locale/cbn_pl.ts \
                src/qt/locale/cbn_pt.ts \
                src/qt/locale/cbn_ru.ts \
                src/qt/locale/cbn_sk.ts \
                src/qt/locale/cbn_sv.ts \
                src/qt/locale/cbn_vi.ts \
                src/qt/locale/cbn_zh_CN.ts \
                src/qt/locale/cbn_zh_TW.ts
