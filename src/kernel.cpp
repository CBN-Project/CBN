...
int nStakeTargetSpacing = 60; // CBN: 1 minute blocks during POS (block 201+)
...
{
    // CBN will hash in the transaction hash and the index number in order to make sure each hash is unique
