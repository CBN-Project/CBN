                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CBN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CBN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cbn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CBN Core"), this);
    aboutAction->setStatusTip(tr("Show information about CBN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CBN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CBN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CBN addresses"));
    ...
    openAction->setStatusTip(tr("Open a cbn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CBN Core help message to get a list with possible CBN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CBN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CBN network", "", count));
}
...
{
    QString strTitle = tr("CBN Core"); // default title
