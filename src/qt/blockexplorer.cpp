...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::CBN, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (cbn.conf).");
            QMessageBox::warning(this, "CBN Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#111111; bgcolor:#fafafa;}\n a, span { font-family: monospace; }\n span.addr {color:#111111; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #fafafa;}\n td.d0 {font-weight: bold; color:#111111;}\n h2, h3 { white-space:nowrap; color:#111111;}\n a { color:#111111; text-decoration:none; }\n a.nav {color:#111111;}\n";
