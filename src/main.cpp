...
#if defined(NDEBUG)
#error "CBN cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ucbn) are considered zero fee (for relaying and mining)
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    else if (nHeight >=    1001 && nHeight <=   44200) {nSubsidy = blockValue * 0.55; }
    else if (nHeight >=   44201 && nHeight <=   87400) {nSubsidy = blockValue * 0.57; }
    else if (nHeight >=   87401 && nHeight <=  130600) {nSubsidy = blockValue * 0.59; }
    else if (nHeight >=  130601 && nHeight <=  173800) {nSubsidy = blockValue * 0.61; }
    else if (nHeight >=  173801 && nHeight <=  217000) {nSubsidy = blockValue * 0.63; }
    else if (nHeight >=  217001 && nHeight <=  260200) {nSubsidy = blockValue * 0.65; }
    else if (nHeight >=  260201 && nHeight <=  303400) {nSubsidy = blockValue * 0.67; }
    else if (nHeight >=  303401 && nHeight <=  346600) {nSubsidy = blockValue * 0.69; }
    else if (nHeight >=  346601 && nHeight <=  389800) {nSubsidy = blockValue * 0.71; }
    else if (nHeight >=  389801 && nHeight <=  433000) {nSubsidy = blockValue * 0.73; }
    else if (nHeight >=  433001 && nHeight <=  476200) {nSubsidy = blockValue * 0.75; }
    else if (nHeight >=  476201 && nHeight <=  519400) {nSubsidy = blockValue * 0.77; }
    else if (nHeight >=  519401 && nHeight <=  562600) {nSubsidy = blockValue * 0.76; }
    else if (nHeight >=  562601 && nHeight <=  605800) {nSubsidy = blockValue * 0.75; }
    else if (nHeight >=  605801 && nHeight <=  649000) {nSubsidy = blockValue * 0.74; }
    else if (nHeight >=  649001 && nHeight <=  692200) {nSubsidy = blockValue * 0.73; }
    else if (nHeight >=  692201 && nHeight <=  735400) {nSubsidy = blockValue * 0.72; }
    else if (nHeight >=  735401 && nHeight <=  778600) {nSubsidy = blockValue * 0.71; }
    else if (nHeight >=  778601 && nHeight <=  821800) {nSubsidy = blockValue * 0.70; }
    else if (nHeight >=  821801 && nHeight <=  865000) {nSubsidy = blockValue * 0.69; }
    else if (nHeight >=  865001 && nHeight <=  908200) {nSubsidy = blockValue * 0.68; }
    else if (nHeight >=  908201 && nHeight <=  951400) {nSubsidy = blockValue * 0.67; }
    else if (nHeight >=  951401 && nHeight <=  994600) {nSubsidy = blockValue * 0.66; }
    else if (nHeight >=  994601 && nHeight <= 1037800) {nSubsidy = blockValue * 0.65; }
    else if (nHeight >= 1037801 && nHeight <= 1081000) {nSubsidy = blockValue * 0.64; }
    else if (nHeight >= 1081001 && nHeight <= 1124200) {nSubsidy = blockValue * 0.63; }
    else if (nHeight >= 1124201 && nHeight <= 1167400) {nSubsidy = blockValue * 0.62; }
    else if (nHeight >= 1167401 && nHeight <= 1210600) {nSubsidy = blockValue * 0.61; }
    else if (nHeight >= 1210601 && nHeight <= 1253800) {nSubsidy = blockValue * 0.60; }
    else if (nHeight >= 1253801 && nHeight <= 1297000) {nSubsidy = blockValue * 0.59; }
    else if (nHeight >= 1297001 && nHeight <= 1340200) {nSubsidy = blockValue * 0.58; }
    else if (nHeight >= 1340201 && nHeight <= 1383400) {nSubsidy = blockValue * 0.57; }
    else if (nHeight >= 1383401 && nHeight <= 1426600) {nSubsidy = blockValue * 0.56; }
    else if (nHeight >= 1426601                      ) {nSubsidy = blockValue * 0.55; }
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // CBN: We use certain sporks during IBD, so check to see if they are
