...
Intro
-----
CBN (CBN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CBN utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run cbn-qt.exe.

CBN Core is the original CBN client and it builds the backbone of the network.
However, it downloads and stores the entire history of CBN transactions;
