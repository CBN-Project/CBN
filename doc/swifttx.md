...
This mechanism has been integrated into Bitcore-Node-CBN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CBN-Project/insight-api-cbn#web-socket-api](https://github.com/CBN-Project/insight-api-cbn#web-socket-api)
* API: [https://github.com/CBN-Project/insight-api-cbn#swifttx-transactions](https://github.com/CBN-Project/insight-api-cbn#swifttx-transactions)
...
By default, the CBN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CBN Core daemon:
