...
In order to support loading of multiple wallets in cbn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cbn.cpp.
...
Changes to cbn.cpp
----------------------
cbn.cpp is the entry point into cbn-qt, and as such, will require some minor modifications to provide hooks for
