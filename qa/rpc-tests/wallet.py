...
#   c) node1 mines 32 blocks, so now node 0 has 500000CBN, node 1 has 4250CBN, node2 has none.
#   d) node0 sends 601 CBN to node2, in two transactions (301 CBN, then 300 CBN).
