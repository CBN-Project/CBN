Contributing to CBN Core
==================================

The CBN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CBN Core project, and is not to be
confused with overall CBN Network Protocol consensus changes.

Whether a pull request is merged into CBN Core rests with the project merge
...
Patches that change CBN consensus rules are considerably more involved than
...
Where a patch set proposes to change the CBN consensus, it must have been
...
The project leader is the release manager for each CBN Core release.
